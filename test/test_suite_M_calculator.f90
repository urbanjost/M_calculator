...
character(len=:),allocatable :: string
   ...
   string='10/3'
   call unit_check('inum0', inum0(string).eq.3, 'checking',string,'==>',inum0(string)+bug,'expected',3)
   string='(444/111+1)*10-5.0'
   call unit_check('inum0', inum0(string).eq.45, 'checking',string,'==>',inum0(string)+bug,'expected',45)
